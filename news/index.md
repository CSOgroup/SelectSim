...
- Updated citation (`inst/CITATION`, `README`) to the published Nature
  ...
  initiation to metastatic progression. *Nature Genetics*. DOI:
  10.1038/s41588-026-02661-4
...
- Removed the C/C++ code dependency to avoid installation difficulties
  across systems.
  - Moved to `Matrix` package functions and removed the `Rcpp` functions
    and compiled code.
